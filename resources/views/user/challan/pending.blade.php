    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Search Pending Challan</h5>
            ...
            <div class="card-body">
                <form action="{{ route('user.challan.pending_challan') }}" method="get">
                    <div class="row">
...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">View Your Pending Challans</h5>
        <div class="header-elements">
            <div class="list-icons">
                <a class="list-icons-item" data-action="collapse"></a>
                <a class="list-icons-item" data-action="reload"></a>
