    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header header-elements-inline">
                <h5 class="card-title">Search Challans In Process in Pre-Prosecution Cell</h5>
            ...
            <div class="card-body">
                <form action="{{ route('user.challan.in_process_challan') }}" method="get">
                    <div class="row">
...
<div class="card">
    <div class="card-header header-elements-inline">
        <h5 class="card-title">View Challans In Process in Pre-Prosecution Cell</h5>
        <div class="header-elements">
            <div class="list-icons">
                <a class="list-icons-item" data-action="collapse"></a>
                <a class="list-icons-item" data-action="reload"></a>
        ...
        <tbody>
            ...
            <tr> 
                ...
                <td class="text-center">
                    ...
                    <form action="{{route('user.challan.destroy',$challan->id)}}" method="POST">
                        @method('DELETE')
                        @csrf
