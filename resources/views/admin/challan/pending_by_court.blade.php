...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>VIEW CHALLAN PENDING BY COURT | Investigation & Monitoring Cell</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">SEARCH CHALLAN WITH COURT PENDENCY</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.challan.pending_by_court') }}" method="get">
                    <div class="row">
...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Challan With Court Pendency Table</h5>
        </div>
