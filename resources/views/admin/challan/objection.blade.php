...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>VIEW CHALLANS WITH OBJECTION | Investigation & Monitoring Cell</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">SEARCH CHALLAN WITH OBJECTION</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.challan.objection') }}" method="get">
                    <div class="row">
...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Challan with Objection Table</h5>
        </div>
