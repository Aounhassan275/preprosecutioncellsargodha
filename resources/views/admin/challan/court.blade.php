...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>VIEW CHALLANS RECEIVED BY COURT | Investigation & Monitoring Cell</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Search Challans Received By Court</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.challan.court') }}" method="get">
                    <div class="row">
...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Challan Received By Court</h5>
        </div>
