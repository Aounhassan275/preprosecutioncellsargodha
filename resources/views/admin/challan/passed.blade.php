    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">SEARCH CHALLAN PASSED BY PROSECUTION BRANCH</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.challan.passed') }}" method="get">
                    <div class="row">
...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Challan Passed By Prosecution Branch Table</h5>
        </div>
