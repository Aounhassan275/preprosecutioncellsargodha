...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>VIEW CHALLANS PENDING BY PROSECUTION BRANCH | Investigation & Monitoring Cell</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">SEARCH CHALLANS PENDING BY PROSECUTION BRANCH</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.challan.pending_by_prosecution') }}" method="get">
                    <div class="row">
                        ...
                        <div class="form-group col-3">
                            ...
                            <select name="police_station" class="form-control select2" required>
                                <option selected disabled>Select</option>
...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Challan Pending By Prosecution Branch Table</h5>
        </div>
