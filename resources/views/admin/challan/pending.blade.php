...
<div class="row mb-2 mb-xl-4">
    ...
    <h3>VIEW CHALLAN PENDING | Investigation & Monitoring Cell</h3>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.challan.pending_challan') }}" method="get">
                    <div class="row">
...
<div class="col-12 ">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title">View Challan Pending Table</h5>
        </div>
